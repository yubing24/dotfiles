...
;; Use ES-lint to fix code issues, such as unused imports
(use-package eslint-fix)

;; Indentation tab and size
(defun set-ecmascript-indentation()
  "Set ECMAScripts (.js/.ts) indentation to 2 spaces."
  (when (or (eq major-mode 'js2-mode) (eq major-mode 'typescript-mode))
    (setq-default indent-tabs-mode nil)
    (setq-default tab-width 2)
    (setq indent-line-function 'insert-tab)))
(add-hook 'js2-mode-hook 'set-ecmascript-indentation)
(add-hook 'typescript-mode-hook 'set-ecmascript-indentation)

;; ESlint hook - lint code before save
