...
(use-package dockerfile-mode
  :ensure-system-package (docker-langserver . "npm i -g dockerfile-language-server-nodejs@latest")
  :defer t)
#+end_src
...
;; Format file once it is saved
(defun format-php-before-save ()
  "Format PHP file with LSP Buffer Format function when file is saved"
  (when (eq major-mode 'php-mode)
      (lsp-format-buffer)))

(add-hook 'before-save-hook #'format-php-before-save)
#+end_src
